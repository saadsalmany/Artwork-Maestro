...
const ProductCard = ({ product }) => {
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col w-full h-min ">
      ...
      <div className="pt-2 pb-6 px-6 flex-grow flex flex-col">
        ...
        <p className="text-sm hidden desktop:flex font-openSans text-charcoal mb-4 min-h-[40px]">
