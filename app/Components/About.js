    ...
    <div className="bg-slate-100 mt-20">
      <div className="max-w-6xl mx-auto px-8 tablet:px-16 desktop:px-26">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div>
              ...
              <p>
                ...
                pieces. Our commitment to quality has earned us recognition from
                the Indian Government and a loyal worldwide customer base.
              </p>
              <Image
            ...
            <div>
              ...
              <p>
                ...
                Expo Mart, featuring a stunning blend of contemporary design and
                timeless elegance. This event wasn't just about products - it
                was a chance to connect with design enthusiasts and share the
          ...
          <div className="mt-10">
            <h2 className="text-secondary-blue text-2xl mb-4">Get in Touch</h2>
            <p>
