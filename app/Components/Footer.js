      ...
      <div className="container max-w-6xl   mx-auto desktop:pt-12 px-8 py-6">
        <div className="flex flex-col desktop:flex-row justify-between items-start desktop::items-center">
          <div className="mb-8 flex flex-col tablet:px-14 desktop:px-0 desktop:mb-0 w-full">
            <div className="flex items-center flex-col tablet:flex-row tablet:items-center desktop:flex-row desktop:items-center space-x-3 mb-12 desktop:mb-10">
              <h6 className="font-outfit font-semibold text-secondary-blue text-3xl mb- flex items-center justify-center">
                Artw
                <span className="inline-block relative">
                  <svg
                    ...
                    viewBox="0 0 40 40"
                    fill="none"
                    className=" justify-center items-center  w-6 h-6 mx-[1px] mt-[3px] desktop:w-6 desktop:h-6 animate-spin-slow"
                  >
                    {/* SVG content */}
                    <path
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center text-sm">
          ...
          <div className="flex mt-4 desktop:-mt-3 flex-wrap justify-center sm:justify-end space-x-4">
            {["Certifications", "|", "FAQs", "|", "Privacy Policy"].map(
              (item, index) => (
                <a
                  key={index}
                  href="#"
