    ...
    <footer className="bg-secondary-blue  text-white py-8">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col desktop:flex-row justify-between items-center desktop:items-start">
          <div className="mb-6 desktop:mb-0">
            ...
            <p className="mt-2 text-sm">
              Address: Mohalla Sarai Tarin, Sambhal, Uttar Pradesh, India
            </p>
            <p className="mt-2 text-sm">Contact: +91 9876543210</p>
            <p className="text-sm">artworkmaestro@site.com</p>
          </div>
          <div className="flex space-x-4 mb-6 desktop:mb-0">
        ...
        <div className="mt-8 text-center text-sm">
          <p>Copyright © 2024 Artwork Maestro. All rights reserved | Powered by Saad Salmany</p>
