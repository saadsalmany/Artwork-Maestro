...
const Footer = () => {
  ...
  return (
    <footer className="bg-secondary-blue text-white font-openSans">
      <div className="container mx-auto px-8 py-8 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Logo and Company Name */}
          <div className="flex flex-col  items-center md:items-start">
            <h6 className="font-outfit text-white font-semibold text-2xl mb-4 flex items-center">
              Artw
              <span className="inline-block relative">
                <svg
                  ...
                  viewBox="0 0 40 40"
                  fill="none"
                  className=" justify-center text-white items-center  w-6 h-6 mx-[1px] mt-[3px] desktop:w-6 desktop:h-6 animate-spin-slow"
                >
                  {/* SVG content */}
                  <path
              ...
              rk
              <span className="ml-1">Maestro</span>
            </h6>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs">
          <p className="mb-6 md:mb-0 font-outfit text-center md:text-left">
            ...
            Powered by{" "}
            <a
              href="https://www.linkedin.com/in/saadsalmany/"
              target="_blank"
              rel="noopener noreferrer"
            >
