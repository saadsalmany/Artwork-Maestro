...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      >
        <div className="content-wrapper desktop:gap-5 tablet:gap-7 gap-2 flex-1 pt-20 tablet:pt-28 desktop:pt-16 flex flex-col tablet:items-center desktop:items-start desktop:max-w-[50%]">
          <h1
