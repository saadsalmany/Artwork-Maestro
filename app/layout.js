...
export const metadata = {
  ...
  description: 'Discover exquisite handcrafted hornware products at Artwork Maestro. Browse our collection of beer cups, bone items, holders, and more for international buyers.',
  keywords: ['hornware', 'handcrafted', 'beer cups', 'bone items', 'holders', 'handicrafts', 'artisanal products'],
  openGraph: {
    title: 'Artwork Maestro | Handcrafted Hornware Products',
